...
<template>
  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          ...
          <el-input placeholder="请输入内容" v-model="queryInfo.query" class="input-with-select" @input="change($event)"
      ...
      <el-table :data="userList" style="width: 100%" border stripe>
        ...
        <el-table-column label="操作" width="200px">
          ...
          <template slot-scope="scope">
            ...
            <!-- 修改用户 -->
            <el-button type="primary" icon="el-icon-edit" size="mini" @click="editDialogVisible(scope.row.id)">
            </el-button>
    ...
    <el-dialog title="添加用户" :visible.sync="addDialogVisible" width="50%" @close="addDialogClosed">
      ...
      <el-form ref="addFormRef" :model="addUserForm" label-width="70px" :rules="addFormRules">
        <el-form-item label="用户名" prop="username">
          <el-input v-model="addUserForm.username" @input="change($event)"></el-input>
        </el-form-item>

        <el-form-item label="密码" prop="password">
          <el-input v-model="addUserForm.password" @input="change($event)" type="password"></el-input>
        </el-form-item>
        <el-form-item label="邮箱" prop="useremail">
          <el-input v-model="addUserForm.useremail" @input="change($event)"></el-input>
        </el-form-item>
        <el-form-item label="手机" prop="usermobile">
          <el-input v-model="addUserForm.usermobile" @input="change($event)"></el-input>
        </el-form-item>
      </el-form>
    ...
    <!-- 修改用户 -->
    <el-dialog title="修改用户" :visible.sync="showDialogVisible" width="50%" @close="editFormClosed">
    ...
    <!-- 分配角色对话框 -->
    <el-dialog title="分配角色" :visible.sync="showRoleDialogVisible" width="40%" @close="setRoleDialogVisibleClosed">
      <div>
